<template>
    ...
    >
        ...
        <div class="footer-btn-wrapper">
            ...
            >
                <img class="footer-btn-img" src="../static/images/btn_home.png" alt />
        ...
        <div class="footer-btn-wrapper">
            ...
            >
                <img class="footer-btn-img" src="../static/images/btn_promotion.png" alt />
        ...
        <div class="footer-btn-wrapper">
            ...
            >
                <img class="footer-btn-img" src="../static/images/btn_wallet.png" alt />
        ...
        <div class="footer-btn-wrapper">
            <a class="footer-btn-container" href="https://line.me/R/ti/p/%40y3thai">
                <img class="footer-btn-img line-image" src="../static/images/btn_line.svg" alt />
            </a>
        </div>
        <!-- Blank -->
        <div class="footer-btn-wrapper">
