		...
		<section class="register-container">
			...
			<div class="register-input-wrapper">
				...
				<ul class="error-msg" id="error-confirm-psw">
					<li class="msg-text"></li>
					<li class="response-msg" v-for="(item, index) in regErrorMsg.password_confirmation" :key="`confirm-psw-${index}`">{{ item }}</li>
				</ul>

				<!-- Full Name -->
				<div class="register-input-container">
					<img class="register-input-img fullname-img" src="/images/fullname_image.png" />
					<input class="register-input-text" id="input-fullname" type="text" :placeholder="$t('common.fullname')" v-model="myFullname" />
				</div>
				...
				<div class="register-input-container">
					...
					<input class="register-input-text" id="input-mobile" type="number" :placeholder="$t('register.mobile_number')" v-model="myMobile" />
				</div>
